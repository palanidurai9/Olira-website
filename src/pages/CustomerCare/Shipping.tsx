    ...
    return (
        <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div className="prose max-w-none text-gray-600 space-y-4">
                <p>At Oliraa, we ensure that your orders reach you in perfect condition and on time.</p>
                ...
                <p>Currently, we only ship within India. We are working on bringing Oliraa to the world soon.</p>
            </div>
        </div>
    );
};
